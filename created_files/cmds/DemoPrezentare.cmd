...
IF EXIST D: (
    mkdir "D:\Nume1"
    :: Set permissions for Nume1 and Admin
    icacls "D:\Nume1" /inheritance:r
    icacls "D:\Nume1" /grant Nume1:"(OI)(CI)F"
    icacls "D:\Nume1" /grant Admin:"(OI)(CI)F"
) ELSE (
...
IF EXIST D: (
    mkdir "D:\Nume2"
    :: Set permissions for Nume2 and Admin
    icacls "D:\Nume2" /inheritance:r
    icacls "D:\Nume2" /grant Nume2:"(OI)(CI)F"
    icacls "D:\Nume2" /grant Admin:"(OI)(CI)F"
) ELSE (
    echo Drive D: not found. Skipping folder creation.
)
IF EXIST F: (
    mkdir "F:\Nume2"
    :: Set permissions for Nume2 and Admin
    icacls "F:\Nume2" /inheritance:r
    icacls "F:\Nume2" /grant Nume2:"(OI)(CI)F"
    icacls "F:\Nume2" /grant Admin:"(OI)(CI)F"
) ELSE (
    echo Drive F: not found. Skipping folder creation.
)
